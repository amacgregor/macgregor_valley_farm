defmodule MacgregorValleyFarmWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MacgregorValleyFarmWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MacgregorValleyFarmWeb.Gettext, "errors", msg, opts)
    end
  end
